...
public class ModelElement
{
    ...
    {
    	if(!metafacades.isEmpty() && ((MetafacadeBase)metafacades.iterator().next()).getComparatorObject() != null)
    		Collections.sort((List)metafacades, ((MetafacadeBase)metafacades.iterator().next()).getComparatorObject());
