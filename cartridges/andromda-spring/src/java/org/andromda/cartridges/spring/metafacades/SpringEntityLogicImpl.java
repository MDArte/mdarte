    ...
    extends SpringEntityLogic
{
    ...
    protected String handleGetHibernateInheritanceStrategy()
    {
        ...
        for (SpringEntity superEntity = this.getParentEntity(); superEntity != null && StringUtils.isBlank(inheritance);)
        {
    ...
    {
        final SpringEntity superEntity = this.getParentEntity();
        return this.isRoot() &&
        (
     ...
     */
    private SpringEntity getParentEntity()
    {
