    ...
    extends StrutsParameterLogic
{
    ...
    protected java.lang.String handleGetMessageKey()
    {
        ...
        final boolean messageKeyDefined = (this.findTaggedValue(Bpm4StrutsProfile.TAGGEDVALUE_VIEW_MESSAGE_KEY)!=null 
				&& !this.findTaggedValue(Bpm4StrutsProfile.TAGGEDVALUE_VIEW_MESSAGE_KEY).equals(""));
        if (!normalizeMessages() && !messageKeyDefined)
        {
        ...
        if(messageKeyDefined){
        	messageKey.append(this.findTaggedValue(Bpm4StrutsProfile.TAGGEDVALUE_VIEW_MESSAGE_KEY));
        }else{
    ...
    protected boolean handleIsValidationRequired()
    {
        ...
        //return !("true".equals(disableValidationForHiddenFormFields) && "hidden".equals(getWidgetType())) && !("plaintext".equals(getWidgetType()))  && !getValidatorTypes().isEmpty();
