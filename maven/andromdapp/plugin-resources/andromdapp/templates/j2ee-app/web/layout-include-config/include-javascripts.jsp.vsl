...
<script type="text/javascript" language="Javascript1.1" src="/${projectId}/layout/${layout}/javaScripts/jquery.ba-hashchange.min.js"></script>
<script type="text/javascript" language="Javascript1.1" src="/${projectId}/layout/${layout}/javaScripts/bootstrap.min.js"></script>
<script type="text/javascript" language="Javascript1.1" src="/${projectId}/layout/${layout}/javaScripts/bootstrap-datepicker.js"></script>
