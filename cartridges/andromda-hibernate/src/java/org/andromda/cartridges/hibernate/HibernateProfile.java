    ...
    extends UMLProfile
{
    ...
    /**
     * Stores batch size for an association end.
     */
    public static final String TAGGEDVALUE_HIBERNATE_ASSOCIATION_BATCH = profile.get("HIBERNATE_ASSOCIATION_BATCH");
    
    /**
     * Stores batch size for an entity
     */
    public static final String TAGGEDVALUE_HIBERNATE_ENTITY_BATCH = profile.get("HIBERNATE_ENTITY_BATCH");    
    
    
    /**
     * Diz qual o valor do atributo lazy
     */
    public static final String TAGGEDVALUE_HIBERNATE_LAZY_TYPE = profile.get("HIBERNATE_LAZY_TYPE");
