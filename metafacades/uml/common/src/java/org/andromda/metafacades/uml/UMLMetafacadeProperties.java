...
public class UMLMetafacadeProperties
{
    ...
    /**
     * The property defines if the constraints should be generated as a code.
     */
    public static final String USE_CODE_CONSTRAINT = "useCodeConstraint";

    /**
     * Define if the Struts 2 should be used as default web technology.
     */
    public static final String PRESENTATION_STRUTS2 = "struts2";
}
