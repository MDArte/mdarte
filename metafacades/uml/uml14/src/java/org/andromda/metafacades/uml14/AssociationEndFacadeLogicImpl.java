    ...
    public Comparator getComparatorObject(){
    	return new Comparator(){
    		public int compare(Object obj1, Object obj2){
    			if(obj1 instanceof AssociationEndFacade && obj2 instanceof AssociationEndFacade){
    				AssociationEndFacade end1 = (AssociationEndFacade)obj1;
    				AssociationEndFacade end2 = (AssociationEndFacade)obj2;
    				return end1.getOtherEnd().getName().compareToIgnoreCase(end2.getOtherEnd().getName());
    			}
